...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout);

        ViewCompat.setNestedScrollingEnabled(this, ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableNestedScrolling, false));
        mDragRate = ta.getFloat(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlReboundDuration, mReboundDuration);
        mEnableLoadmore = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableLoadmore, mEnableLoadmore);
        mHeaderHeight = ta.getDimensionPixelOffset(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlHeaderHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFooterHeight, density.dip2px(60));
        mDisableContentWhenRefresh = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadmore = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableAutoLoadmore, mEnableAutoLoadmore);
        mEnableOverScrollBounce = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableScrollContentWhenRefreshed, mEnableScrollContentWhenRefreshed);
        mEnableLoadmoreWhenContentNotFull = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableLoadmoreWhenContentNotFull, mEnableLoadmoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenLoadFinished);
        mEnableOverScrollDrag = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFixedFooterViewId, View.NO_ID);

        mManualLoadmore = ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableLoadmore);
        mManualNestedScrolling = ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableNestedScrolling);
        mManualHeaderTranslationContent = ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableHeaderTranslationContent);
        mHeaderHeightStatus = ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
        ...
        int accentColor = ta.getColor(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlAccentColor, 0);
        int primaryColor = ta.getColor(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
    ...
    protected void onMeasure(final int widthMeasureSpec,final int heightMeasureSpec) {
        ...
        for (int i = 0, len = getChildCount(); i < len; i++) {
            ...
            if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
                ...
                final com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams lp = (com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams) headerView.getLayoutParams();
            ...
            if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
                ...
                final com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams lp = (com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams) footerView.getLayoutParams();
                final int widthSpec = getChildMeasureSpec(widthMeasureSpec, lp.leftMargin + lp.rightMargin, lp.width);
                int heightSpec = heightMeasureSpec;
            ...
            if (mRefreshContent != null && mRefreshContent.getView() == child) {
                final com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams lp = (com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams) mRefreshContent.getLayoutParams();
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams;
    }

    @Override
    protected com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams generateDefaultLayoutParams() {
        return new com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams(MATCH_PARENT, MATCH_PARENT);
    }

    @Override
    protected com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams(p);
    }

    @Override
    public com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams(getContext(), attrs);
    }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_Layout);
            backgroundColor = ta.getColor(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_Layout_layout_srlBackgroundColor, backgroundColor);
            if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_Layout_layout_srlSpinnerStyle)) {
                spinnerStyle = SpinnerStyle.values()[ta.getInt(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_Layout_layout_srlSpinnerStyle, SpinnerStyle.Translate.ordinal())];
            }
            ta.recycle();
        }
...
//        }
    ...
    public SmartRefreshLayout setRefreshHeader(RefreshHeader header, int width, int height) {
        if (header != null) {
            ...
            if (header.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
                this.addView(mRefreshHeader.getView(), 0, new com.scwang.smartrefresh.layout.SmartRefreshLayout.LayoutParams(width, height));
            } else {
    ...
    public SmartRefreshLayout setRefreshFooter(RefreshFooter footer, int width, int height) {
        if (footer != null) {
            ...
            if (mRefreshFooter.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
                this.addView(mRefreshFooter.getView(), 0, new SmartRefreshLayout.LayoutParams(width, height));
            } else {
    ...
    public RefreshLayout setRefreshContent(View content, int width, int height) {
        if (content != null) {
            ...
            addView(content, 0, new SmartRefreshLayout.LayoutParams(width, height));
            if (mRefreshHeader != null && mRefreshHeader.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
